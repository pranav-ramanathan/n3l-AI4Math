...
\textbf{SciML.} The continuous-relaxation gradient flow recovered optimal $2n$-point configurations on Apple Metal for every grid size between $n=10$ and $n=18$ except $n=17$, with success rates per ten parallel runs ranging from $4/10$ at $n=14$ to $10/10$ at $n=10$ and $n=12$. The best $n=18$ run reached the full $36$-point configuration in roughly $588$ seconds of mean solver time on an Apple M2, without exploiting symmetry. Two failure modes are visible. At $n=17$ no run reached zero violations: the best configuration placed $33$ points with a single residual collinearity, suggesting that the energy landscape narrows sharply at this grid size. At $n=19$ no run achieved a valid configuration; the best attempt reached $35$ points with three violations, leaving a small but persistent gap between the relaxed and discrete optima. Section~3.5 examines how the collinearity penalty $\alpha$ scales with $n$ and how this scaling correlates with success.
