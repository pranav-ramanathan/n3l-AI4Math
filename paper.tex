...
\textbf{Implementation.} The resulting ILP model contains $n^2$ binary variables and $O(n^3)$ linear constraints, corresponding to the number of distinct lines passing through at least three grid points. We solve the model using Gurobi's branch-and-bound algorithm \cite{NemhauserWolsey1988,Huang2021} with default settings for cutting planes and primal heuristics.
